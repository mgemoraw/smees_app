      ...
      children: [
          ...
          ExpansionTile(
            ...
            trailing: IconButton(
              ...
              icon: const Icon(Icons.delete, semanticLabel: "Clear All Data", grade: 25),
            ),
                    ...
                    child: DataTable(
                      ...
                      rows: data.map((row) {
                        ...
                        return DataRow(cells: [
                          ...
                          DataCell(Text("${test.testStarted!.day}-${test.testStarted!.month}-${test.testStarted!.year} ")), // 
                          DataCell(Text("${test.testStarted!.hour}:${test.testStarted!.minute}:${test.testStarted!.second}")), // 
                          DataCell(Text("${test.testEnded!.hour}:${test.testEnded!.minute}:${test.testEnded!.second}")), // 
